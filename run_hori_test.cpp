...
//                program.
// 2017-05-03 By Changxin Yan
// Modifications were done to use this node and run the EduMip horizontally. Basically the idea
// is to disable the d1 controller.         
...
int main(int argc, char** argv)  
{
  ...
  // CCX use another node name
  ros::init(argc, argv, "edumip_hori_ros_node");
 ...
 *  hori_controller()
 *  
 *  this function is created by modifying the previous balance_controller function
 *  used to control the edumip robot run horizontally
 *******************************************************************************/
void balance_controller()
{
  ...
  // check for a tipover
  // 2017-04-17 CXY do not need this check
  ...
  // 2017-04-18 for the saturation problem
   ...
   ***********************************************************/
  // 2017-04-18 CXY do not need d1 controller
